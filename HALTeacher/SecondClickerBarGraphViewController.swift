//
//  SecondClickerBarGraphViewController.swift
//  HALTeacher
//
...
class SecondClickerBarGraphViewController: UIViewController, SecondViewCoreCentralManagerDelegate, DrawClickerBarGraphViewDelegate {
...
//        self.graphView.backgroundColor = UIColor.clearColor()
        ...
        //問題数格納
        var questionCount = ClickerInfo.clickerInfoInstance.answerNumber!
        ...
        if viewFlag {
            ...
            self.view.addSubview(drawClickerBarGraphView)
