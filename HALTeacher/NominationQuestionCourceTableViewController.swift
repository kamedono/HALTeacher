//
//  NominationQuestionCourceTableViewController.swift
//  HALTeacher
//
...
class NominationQuestionCourceTableViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, XmlModuleDelegate, TeacherMoodleAccessDelegate, RightViewControllerDelegate {
    ...
    func finishRead() {
        ...
        dispatch_async(dispatch_get_main_queue(), {
            self.downloadingAlertView.dismissViewControllerAnimated(true, completion: {
                self.performSegueWithIdentifier("goNominationQuestionSelectTableViewControllerSegue", sender: self)
            })
        })
