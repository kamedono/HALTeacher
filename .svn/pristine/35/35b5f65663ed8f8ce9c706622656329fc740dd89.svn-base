//
//  NominationGraphViewController.swift
//  HALTeacher
//
//  Created by Toshiki Higaki on 2015/10/08.
...
class NominationGraphViewController: UIViewController, SecondViewCoreCentralManagerDelegate, UITableViewDelegate, UITableViewDataSource {
