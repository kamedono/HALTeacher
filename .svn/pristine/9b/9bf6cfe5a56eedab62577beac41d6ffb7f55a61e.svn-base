...
class KyControlViewController: UIViewController, UIScrollViewDelegate, MenuViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        [
            MenuElem(name: "menu1", className: "SomeViewController", sbName: "Main"),
            MenuElem(name: "menu2", className: "SomeViewController", sbName: "Main"),
            MenuElem(name: "menu3", className: "SomeViewController", sbName: "Main"),
            MenuElem(name: "menu4", className: "SomeViewController", sbName: "Main"),
            MenuElem(name: "menu5", className: "SomeViewController", sbName: "Main"),
            MenuElem(name: "menu6", className: "SomeViewController", sbName: "Main"),
        ]
    ...
    func setupContentScrollView(menus: Array<MenuElem>) {
        ...
        for menu in menus {
            ...
            let vc = sb.instantiateViewControllerWithIdentifier("someViewController") as! UIViewController
            vc.menu = menu
